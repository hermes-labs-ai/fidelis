...
def main():
    ...
    p_mcp = sub.add_parser("mcp", help="Manage Claude Code, Codex, GitHub Copilot CLI, or Gemini CLI MCP integration")
    ...
    p_mcp_install.add_argument("--client", choices=("claude", "codex", "copilot", "gemini"), default="claude",
    ...
    p_mcp_uninstall.add_argument("--client", choices=("claude", "codex", "copilot", "gemini"), default="claude",
                                 help="MCP client to configure (default: claude)")
